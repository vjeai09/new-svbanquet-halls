...
const Services = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "బారసాల, లంగా ఓణీ వేడుక & more — we honor every milestone.",
      ...
      details: [
        ...
        "Half-Saree Ceremony (లంగా ఓణీ వేడుక): Celebrate your daughter's coming-of-age with the grandeur it deserves — elegant décor, stage setup, and room for the whole family.",
